...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=10000,
                                    step=1000,
                                    marks={0: '0', 100: '1000', 2000: '2000', 3000: '3000', 4000: '4000', 5000: '5000', 6000: '6000', 7000: '7000', 8000: '8000', 9000: '9000', 10000: '10000'},
                                    value=[0, 10000]
                                ),
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Calculate success percentage for all sites
        success_percentage = spacex_df[spacex_df['class'] == 1].groupby('Launch Site').size() / spacex_df.groupby('Launch Site').size() * 100
        title = 'Success Percentage for All Sites'
        fig = px.pie(
        ...
        # Calculate success count for the selected site
        site_data = spacex_df[spacex_df['Launch Site'] == entered_site]
        total_success = site_data[site_data['class'] == 1]['class'].count()
        total_failed = site_data[site_data['class'] == 0]['class'].count()
